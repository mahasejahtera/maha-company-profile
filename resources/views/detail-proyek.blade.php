...
<head>
    ...
    <title>Detail - PT Maha Akbar Sejahtera </title>
</head>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-none d-lg-inline-block text-center nav-center-wrap">
                        <ul class="js-clone-nav  text-center site-menu p-0 m-0">
                            <li><a href="/">Home</a></li>
                            <li class="active"><a href="about.html">Detail</a></li>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-start">
                <div class="col-lg-6 mx-auto text-center">
                    <h1 class="heading" data-aos="fade-up">Nama Proyek</h1>
                    <p data-aos="fade-up">Lokasi Proyek</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="categories">
                            ...
                            <img src="images/hero_1.jpg" class="img-fluid" alt="">
                            <img src="images/hero-kontak.jpg" class="img-fluid" alt="">
